...
void tray_run(void) {
    @autoreleasepool {
        ...
        NSMenuItem *github = [[NSMenuItem alloc] initWithTitle:@"View at github.com/samuelcolvin/nextcall"
...
// may be called from Rust worker threads (and before tray_run - the update
// is applied once the run loop starts).
